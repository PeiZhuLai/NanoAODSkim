    ...
    with open('input_data_Files/'+InputFileFromWhereReadDASNames) as in_file:
        ...
        for SampleDASName in in_file:
            ...
            for root_file in output.split():
                ...
                outjdl_file.write("Arguments = "+(xrd_redirector+root_file)+" "+skimmed_output_path+"/"+output_string+"/"+root_file.split('/')[-1].replace(".root","skimmed.root")+"  "+skimmed_output_path+"\n")
