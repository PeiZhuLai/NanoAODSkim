...
def main():
    ...
    if moduleyear == "2023postBPix":
        ...
        modulesToRun.extend([jetmetCorrector(),LHEScaleSF(),muonScaleResRun3_2023BPix()])
    ...
    if moduleyear == "2023preBPix":
        ...
        modulesToRun.extend([jetmetCorrector(),LHEScaleSF(),muonScaleResRun3_2023()])
    ...
    if moduleyear == "2022postEE":
        ...
        modulesToRun.extend([jetmetCorrector(),LHEScaleSF(),muonScaleResRun3_2022EE()])
    ...
    if moduleyear == "2022preEE":
        ...
        jetmetCorrector = createJMECorrector(isMC=isMC, dataYear="2022preEE", jesUncert="All", jetType = "AK4PFPuppi", applyHEMfix=True)
        modulesToRun.extend([jetmetCorrector(),LHEScaleSF(),muonScaleResRun3_2022()])
