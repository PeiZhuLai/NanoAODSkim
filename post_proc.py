...
def main():
    ...
    if moduleyear == "2023postBPix":
        ...
        modulesToRun.extend([jetmetCorrector(),puAutoWeight_UL2023PostBpix(),muonScaleResRun3_2023BPix()])
    ...
    if moduleyear == "2023preBPix":
        ...
        modulesToRun.extend([jetmetCorrector(),puAutoWeight_UL2023PostBpix(),muonScaleResRun3_2023()])
    ...
    if moduleyear == "2022postEE":
        ...
        modulesToRun.extend([jetmetCorrector(),puAutoWeight_UL2022PostEE(),muonScaleResRun3_2022EE()])
    ...
    if moduleyear == "2022preEE":
        ...
        jetmetCorrector = createJMECorrector(isMC=isMC, dataYear="2022preEE", jesUncert="All", jetType = "AK4PFPuppi", applyHEMfix=True)
        modulesToRun.extend([jetmetCorrector(),puAutoWeight_UL2022PreEE(),muonScaleResRun3_2022()])
